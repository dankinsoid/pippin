	...
	@Suite struct MacroTests {
		...
		@Test func seqBuiltins() throws {
			...
			do {
				...
				#expect(message("(seq 1)") == "Don't know how to create ISeq from: long")
				...
				#expect(message("(doall (concat [1] 2))") == "Don't know how to create ISeq from: long")
				#expect(message("(pr-str (concat [1] 2))") == "Don't know how to create ISeq from: long")
		...
		@Test func nameBuiltins() throws {
			...
			do {
				...
				#expect(message("(symbol 1)") == "no conversion to symbol from: long")
				#expect(message("(symbol 1 \"a\")") == "namespace must be a string or nil, got: long")
				...
				#expect(message("(name 1)") == "long cannot be cast to a named value")
				...
				#expect(message("(gensym 1)") == "gensym prefix must be a string or symbol, got: long")
			}
			#expect(clj_debug_live_objects() == before)
		}
		...
		@Test func exInfoAndThrow() throws {
			...
			do {
				...
				#expect(message("(ex-info 1 {})") == "ex-info message must be a string, got: long")
				#expect(message("(ex-info \"m\" 1)") == "ex-info data must be a map, got: long")
				#expect(message("(ex-info \"m\" {} 1)") == "ex-info cause must be an exception, got: long")
