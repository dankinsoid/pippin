...
private let cases: [FormatCase] = [
	...
	c(#"(format "%.25f" 1.5)"#, "1.5000000000000000000000000"),
	c(#"(format "%.30f" 123456.75)"#, "123456.750000000000000000000000000000"),
	c(#"(format "%.22e" 1.5)"#, "1.5000000000000000000000e+00"),
	c(#"(format "%.20g" 0.1)"#, "0.10000000000000000000"),
