	...
	@Suite struct MetaTests {
		...
		@Test func varMetaAltersAtomically() throws {
			...
			do {
				...
				#expect(message(rt, "(alter-meta! [] assoc :a 1)") == "alter-meta! expects a var, an atom or a namespace, got: vector")
				#expect(message(rt, "(reset-meta! [] {})") == "reset-meta! expects a var, an atom or a namespace, got: vector")
