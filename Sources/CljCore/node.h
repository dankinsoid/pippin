...
// into DIRECT_CALL, INVOKE of a listed core var into INTRINSIC, a consumer over lazy stages into FUSED. Runs
// on an analyzed, unnumbered tree; a tree read from data is taken as already optimized.
